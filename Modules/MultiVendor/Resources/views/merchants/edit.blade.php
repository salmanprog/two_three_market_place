            ...
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex">
                        <h3 class="mb-0 mr-30">{{ __('common.update') }} {{ __('common.seller') }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="white_box_50px box_shadow_white">
                    <form action="{{ route('admin.merchant.update', $user->id) }}" method="POST" id="staff_addForm"
                            ...
                            <div class="col-xl-4">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="email" class="primary_input_field user_id name"
                                        placeholder="{{ __('common.email_or_phone') }}" type="text" value="@if(old('email')) {{ old('email') }} @else{{ $user->email ? $user->email : $user->username }}@endif">
                                    ...
                                    <ul id="theme_nav" class="permission_list sms_list ">
                                        <li>
                                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12 extra_width">
                                                <input name="status" id="status_active" value="1" {{ $user->is_active == 1 ? 'checked' : '' }} class="active"
                                                    type="radio">
                                        ...
                                        <li>
                                            <label data-id="color_option" class="primary_checkbox d-flex mr-12 extra_width">
                                                <input name="status" value="0" id="status_inactive" class="de_active" type="radio" {{ $user->is_active == 0 ? 'checked' : '' }}>
                                                <span class="checkmark"></span>
                                            </label>

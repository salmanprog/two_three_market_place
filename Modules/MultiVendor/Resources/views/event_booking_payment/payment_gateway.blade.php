    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-xl-6">
                ...
                <form id="payform" action="{{route('event.event_booking_payment')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="debug_field" value="debug_value">
                    <input type="hidden" name="plane_id" value="{{$events->id}}">
                    <input type="hidden" name="plane_name" value="{{$events->title}}">
                    <input type="hidden" name="plan_price" value="{{$events->price}}">
                    <input type="hidden" name="plane_booking_id" value="{{$bookingevents->id}}">
                                        ...
                                        <div id="collapse{{$key}}" class="accordion-collapse collapse {{$key == 0?'show':''}}" aria-labelledby="heading{{$key}}" data-bs-parent="#accordionExample">
                                            <div class="accordion-body" id="acc_{{$payment->id}}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input type="hidden" name="quantity" value="{{$bookingevents->no_of_ticket}}">
            ...
            <div class="col-lg-6">
                    <div class="order_sumery_box flex-fill">
                        ...
                        <div class="subtotal_lists">
                                ...
                                <div class="single_total_list d-flex align-items-center">
                                    <div class="single_total_left flex-fill">
                                        <span class="total_text">{{ __("common.discount") }} </span>
                                    </div>
                                    <div class="single_total_right">
                                ...
                                <div class="total_amount d-flex align-items-center flex-wrap pb_25">
                                    ...
                                    <div class="single_total_right">
                                        <span class="total_text"  > {{ single_price($vat + $total_pay) }} </span>
                                    </div>
                                </div>

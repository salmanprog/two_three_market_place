...
Route::prefix('seller')->as('seller.')->group(function() {
    ...
    Route::get('/seller-subscription-payment-select/{id}', 'SellerController@subscriptionPaymentPageDetails')->name('subscription_payment_select')->middleware('permission');

    Route::get('subscription/payment/{id}','SellerController@subscriptionPaymentPage')->name('subscriptionPaymentGateway');

    Route::post('/seller-subscription-payment', 'SellerController@subscriptionPayment')->name('subscription_payment');
    
    // Simple test route
    Route::get('/test-subscription-controller', 'SellerController@subscriptionPayment')->name('test_subscription_controller');
    ...
    Route::post('plan/apply-coupon/{plan_id}','SellerController@planApplyCoupon')->name('plan.apply_coupon');
});

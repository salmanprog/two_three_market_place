                        ...
                        <div role="tabpanel" class="tab-pane fade active show" id="all_customer">
                            ...
                            <div class="QA_section QA_section_heading_custom check_box_table">
                                <div class="QA_table">
                                    <!-- table-responsives -->
                                    <div class="">
                                        @include('customer::artgallery.components.all_lists')
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="active_customer">
                            ...
                            <div class="QA_section QA_section_heading_custom check_box_table">
                                <div class="QA_table">
                                    <!-- table-responsive -->
                                    <div class="">
                                        @include('customer::artgallery.components.active_lists')
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="in_active_customer">
                            ...
                            <div class="QA_section QA_section_heading_custom check_box_table">
                                <div class="QA_table">
                                    <!-- table-responsive -->
                                    <div class="">
                                        @include('customer::artgallery.components.in_active_lists')
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                $(document).ready(function(){
                    ...
                    function activeCustomerDataTable(){
                        $('#activeCustomerTable').DataTable({
                            ...
                            stateSave: true,
                            "ajax": ( {
                                url: "{{ route('art-gallery.list.get-data') }}" + '?table=active_customer'
                            }),
                    ...
                    function allCustomerDataTable(){
                        $('#allCustomerTable').DataTable({
                            ...
                            stateSave: true,
                            "ajax": ( {
                                url: "{{ route('art-gallery.list.get-data') }}" + '?table=all_customer'
                            }),
                            "initComplete":function(json){
                    ...
                    function inactiveCustomerDataTable(){
                        $('#inactiveCustomerTable').DataTable({
                            ...
                            stateSave: true,
                            "ajax": ( {
                                url: "{{ route('art-gallery.list.get-data') }}" + '?table=inactive_customer'
                            }),
                            "initComplete":function(json){

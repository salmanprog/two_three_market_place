...
Route::prefix('customer')->group(function() {
    ...
    Route::get('/active-art-gallery-list', 'CustomerController@art_gallery_index')->name('art-gallery.list_active')->middleware(['auth','admin']);
    ...
    Route::get('/art-gallery-list/get-data', 'CustomerController@art_gallery_get_data')->name('art-gallery.list.get-data')->middleware(['auth','admin']);
...
Route::prefix('admin')->middleware(['auth','admin'])->as('admin.')->group(function () {
   ...
   Route::get('/designer/{id}/destroy', 'CustomerController@interior_designer_destroy')->name('designer.destroy');

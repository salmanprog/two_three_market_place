                                ...
                                <div class="QA_table ">
                                    <table class="table Crm_table_active3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="running_balance">{{ getNumberTranslate(@$transaction->user->SellerCurrentWalletAmounts) }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('wallet.pending_withdraw_request_balance') }}</th>
                                            <td class="pending_withdraw_balance">{{getNumberTranslate(@$transaction->user->SellerPendingWithdrawAmounts)}}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('wallet.remaining_balance') }}</th>
                                            <td class="remaining_balance">{{getNumberTranslate(@$transaction->user->SellerCurrentWalletAmounts - @$transaction->user->SellerPendingWithdrawAmounts)}}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bank_account_number">{{getNumberTranslate(@$transaction->user->SellerBankAccount->bank_account_number)}}</td>
                                        </tr>
                                        <tr>

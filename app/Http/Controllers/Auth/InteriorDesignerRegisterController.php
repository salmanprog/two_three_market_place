...
class InteriorDesignerRegisterController extends Controller
{
    ...
    public function create($data)
    {
        ...
        $user =  User::create([
            ...
            'web_site_url' => isset($data['web_site_url']) ? $data['web_site_url'] : NULL,
    ...
    public function showRegistrationForm()
    {
        ...
        return view(theme('auth.interior_designer_register'),compact('row','form_data','loginPageInfo'));
    }

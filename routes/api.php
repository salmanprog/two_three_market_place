...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // customer delete
    Route::post('/customer-delete', [AuthController::class, 'customerDelete']);
...
// category api
Route::get('/category-list', [\Modules\Product\Http\Controllers\API\CategoryController::class, 'index']);
Route::get('/product/category/{categoryId}', [\Modules\Product\Http\Controllers\API\CategoryController::class, 'show']);

...
Route::group(['middleware' => ['auth','customer']], function () {
    ...
    Route::get('/resell-product',[OrderController::class,'myPurchaseHistories'])->name('frontend.resell_product_list');
    Route::get('/resell-product/{id}', [OrderController::class, 'resellProduct'])->name('frontend.resell_product');
...
Route::get('/artists', [App\Http\Controllers\Frontend\MerchantsListController::class, 'index'])->name('frontend.artists');

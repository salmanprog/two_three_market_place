    ...
    <div class="amazy_login_area">
        ...
        <div class="amazy_login_area_left d-flex align-items-center justify-content-center">
            <div class="amazy_login_form">
                ...
                <h3 class="m-0">Art Gallery {{__('auth.Sign Up')}}</h3>
                <p class="support_text">{{__('auth.See your growth and get consulting support!')}}</p>
                <form id="registerForm" action="{{route('frontend.art-gallery.store')}}" method="POST" class="register_form">
                    @csrf
                    <div class="row">
                        @php
                            $custom_field = [];
                        ...
                        @else
                            ...
                            <div class="col-lg-12 mb_20">
                                <label class="primary_label2">{{ __('Art Gallery Name') }} <span>*</span></label>
                                <input type="text" name="name" id="Shop" value="{{old('name')}}" placeholder="{{ __('Art Gallery Name') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{ __('Art Gallery Name') }}'" class="primary_input3 radius_5px">
                                @error('name')
                                    <span class="text-danger" >{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <p class="sign_up_text">{{ __('Already an art gallery') }}  <a href="{{route('art-gallery.login')}}">{{__('auth.Sign In')}}</a></p>
                        </div>
                    </div>
                </form>
            </div>

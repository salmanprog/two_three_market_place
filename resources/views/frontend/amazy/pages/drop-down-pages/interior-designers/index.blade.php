...
@section('title')
Interior Designers | {{ config('app.name') }}
@endsection

@section('share_meta')
<meta name="title" content="Interior Designers | {{ config('app.name') }}">
<meta name="description" content="Interior designers — discount tiers, dashboard, and art sourcing at {{ config('app.name') }}.">
<meta property="og:title" content="Interior Designers | {{ config('app.name') }}" />
<meta property="og:description" content="Interior designers — discount tiers, dashboard, and art sourcing." />
...
<div class="how-partner-page">
            ...
            <div class="row align-items-center g-4 g-lg-5">
                <div class="col-12 col-lg-6">
                    <figure class="how-partner-media mb-0" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="80" data-aos-easing="ease-out-cubic" data-aos-anchor-placement="top-bottom">
                        <img src="{{asset('public/images/interior-designers/how-we-partaner.png')}}" alt="How we partner with interior designers" width="750" height="500" loading="lazy" decoding="async">
                    </figure>
                </div>
                <div class="col-12 col-lg-6">
    ...
    @include('frontend.amazy.pages.partials.interior-designer-profile-tiers')
</div>
@endsection

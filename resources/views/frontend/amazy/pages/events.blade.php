...
<section class="how-partner-section py-50 py-lg-100 overflow-visible" id="find-local-art-shows">
    <div class="container">
        ...
        <div class="row align-items-center g-4 g-lg-5">
            <div class="col-12 col-lg-6">
                <figure class="how-partner-media mb-0" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="80" data-aos-easing="ease-out-cubic" data-aos-anchor-placement="top-bottom">
                    <img src="{{asset('public/images/events/find-local-art-shows.jpg')}}" alt="Office and workspace art on {{ config('app.name') }}" width="750" height="500" loading="lazy" decoding="async">
                </figure>
            </div>
            <div class="col-12 col-lg-6">
                <div class="how-partner-prose primary-font ps-lg-2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="140" data-aos-easing="ease-out-cubic" data-aos-anchor-placement="top-bottom">
                    <h2 class="how-partner-lead secondry-font">Our Locations are constantly hosting new art shows for you to enjoy! Some of these events will be free, and some are ticketed.</h2>
                    <p>
...
<section class="how-partner-section py-50 py-lg-100 overflow-visible" id="find-an-artist-for-your-event">
    <div class="container">
        <h1 class="secondry-font fs-55 fw-700 text-center text-black mb-40 line-height-1-2 mx-auto" style="max-width: 920px;" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-out-cubic" data-aos-anchor-placement="top-bottom">Find an Artist for Your Event</h1>

        <div class="row align-items-center g-4 g-lg-5">
            <div class="col-12 col-lg-6">
                <figure class="how-partner-media mb-0" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="80" data-aos-easing="ease-out-cubic" data-aos-anchor-placement="top-bottom">
                    <img src="{{asset('public/images/events/find-an-artist for-your-event.jpg')}}" alt="Office and workspace art on {{ config('app.name') }}" width="750" height="500" loading="lazy" decoding="async">
                </figure>
            </div>
            <div class="col-12 col-lg-6">
                <div class="how-partner-prose primary-font ps-lg-2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="140" data-aos-easing="ease-out-cubic" data-aos-anchor-placement="top-bottom">
                    <h2 class="how-partner-lead secondry-font">We allow anyone to use our Event Organizer. All art events have to meet the requirements and be pre-approved. Locations have special discounts and access to our artists. Our Event Organizer will allow you to host your own art shows!

</h2>
                    <p>
                    Filter through local artists, send them a request, and the artist will reply to your invitation. Once you have the artists you want and have decided on the ticket price, post your event and start promoting to your heart’s desire.
                    </p>
                </div>
            </div>
        </div>

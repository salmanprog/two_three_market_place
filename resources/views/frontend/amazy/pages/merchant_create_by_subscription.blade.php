                ...
                <div class="new_pricing_card">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                         ...
                         @if($item->is_featured == 1)
                            <span class="discount_badge">30% Off - Best Value</span>
                         @endif
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="price_meta">
                                <span>Per Month</span>
                                {{-- <span style="color:#666; font-size:12px;">Instead of ...</span> --}}
                            </div>
                        </div>
                        <!-- <div class="billed_yearly">
                             {{single_price($item->yearly_cost)}} / year - billed yearly
                        </div> -->
                    </div>
                    ...
                    <ul class="feature_list">
                        ...
                        @else
                        <li><i class="fas fa-users"></i> {{ __('defaultTheme.team_member') }} : {{$item->team_size}}</li>
                        <li><i class="fas fa-box"></i> {{__('defaultTheme.products')}} : {{$item->stock_limit}}</li>
                        <li><i class="fas fa-list"></i> {{__('defaultTheme.categories')}} : {{$item->category_limit}}</li>

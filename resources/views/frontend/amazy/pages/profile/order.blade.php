                            ...
                            <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                                <div class="d-flex flex-column  ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('common.order_id')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ getNumberTranslate($order->order_number) }}</p>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_date')}} : </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ getNumberTranslate($order->created_at) }}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_amount')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ single_price($order->grand_total) }}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column  ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.paid_by')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ $order->GatewayName }}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column  ">
                                    <a download="" class="amaz_primary_btn gray_bg_btn min_200 radius_3px" href="{{ route('frontend.my_purchase_order_pdf', encrypt($order->id)) }}" target="_blank">{{__('defaultTheme.download_invoice')}}</a>
                                </div>
                            </div>
                        ...
                        <div class="white_box style2 bg-white mb_20">
                            <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                                <div class="d-flex flex-column  ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('common.order_id')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ getNumberTranslate($no_paid_order->order_number) }}</p>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_date')}} : </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ getNumberTranslate($no_paid_order->created_at) }}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_amount')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ single_price($no_paid_order->grand_total) }}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column  ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.paid_by')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{@$no_paid_order->GatewayName}}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column  ">
                                    <a href="{{ route('frontend.my_purchase_order_pdf', encrypt($no_paid_order->id)) }}" download="" target="_blank" class="amaz_primary_btn gray_bg_btn min_200 radius_3px">+ {{__('defaultTheme.download_invoice')}}</a>
                                </div>
                            </div>
                            <div class="dashboard_white_box_body">
                                <div class="table-responsive mb_10">
                        ...
                        <div class="white_box style2 bg-white mb_20">
                            <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                                <div class="d-flex flex-column  ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('common.order_id')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ getNumberTranslate(@$order_package->order->order_number) }}</p>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_date')}} : </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ getNumberTranslate(@$order_package->order->created_at) }}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_amount')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ single_price(@$order_package->order->grand_total) }}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column  ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.paid_by')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{@$order_package->order->GatewayName}}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column  ">
                                    <a href="{{ route('frontend.my_purchase_order_pdf', encrypt(@$order_package->order->id)) }}" download="" target="_blank" class="amaz_primary_btn gray_bg_btn min_200 radius_3px">+ {{__('defaultTheme.download_invoice')}}</a>
                                </div>
                            </div>
                            <div class="dashboard_white_box_body">
                                <div class="table-responsive mb_10">
                        ...
                        <div class="white_box style2 bg-white mb_20">
                            <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                                <div class="d-flex flex-column  ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('common.order_id')}}: </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ @$order_package->order->order_number }}</p>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_date')}} : </h4>
                                        <p class="font_14 f_w_400 m-0 lh-base"> {{ @$order_package->order->created_at }}</p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                ...
                                <div class="d-flex flex-column  ">
                                    <a download="" href="{{ route('frontend.my_purchase_order_pdf', encrypt(@$order_package->order->id)) }}" target="_blank" class="amaz_primary_btn gray_bg_btn min_200 radius_3px">+ {{__('defaultTheme.download_invoice')}}</a>
                                </div>
                            </div>
                            <div class="dashboard_white_box_body">
                                <div class="table-responsive mb_10">

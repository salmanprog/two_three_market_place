                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <label class="primary_selectlabel alert alert-warning">
                                                {{__('Status is not changable after delivered the order')}}
                                            </label>
                                        </div>
                                    </div>
                                    @else
                                <form action="{{ route('order_manage.update_customer_delivery_status', $order->id) }}" method="post">
                                @csrf
                                    ...
                                    <div class="col-lg-12 p-0">
                                        <div class="primary_input mb-25">
                                            ...
                                            <select class="primary_select mb-25" name="delivery_status" id="delivery_status" >
                                                @foreach ($processes as $key => $process)
                                                    <option value="{{ $process->id }}" @if ($order->order_status == $process->id) selected @endif>{{ $process->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>

                        ...
                        @else
                            ...
                            <div class="col-12 mb_20">
                                <label class="primary_checkbox d-flex">
                                    ...
                                    <span class="checkmark mr_15"></span>
                                    <span class="label_name f_w_400 ">By signing up, you agree to <a href="{{ route('terms-of-use') }}">Terms of Service</a>, <a href="{{ route('privacy-policy') }}">Privacy Policy</a>, and <a href="./art/artist-agreement">Artist Agreement</a>.</span>
                                </label>
                            </div>

    ...
    (function($){
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '.getFilterUpdateByIndex', function(event){
                ...
                $('#pre-loader').show();
                $.ajax({
                    url: '{{ route("frontend.sort_product_filter_by_type") }}',
                    type: "GET",
                    data: {
                        sort_by: sort_by,
                        paginate: paginate
            ...
            function fetch_filter_data(page){
                ...
                var paginate = $('#paginate_by').val();
                var sort_by = $('#product_short_list').val();
                var url = "{{route('frontend.sort_product_filter_by_type')}}";
                var query = {
                    page: page
                };
                if (sort_by) {
            ...
            function getProductByChoice(type,el)
            {
                ...
                if (type == "cat" || type =="brand") {
                    $.ajax({
                        url: '{{ route("frontend.get_colors_by_type") }}',
                        type: "POST",
                        data: {
                            _token: '{{ csrf_token() }}',
                            id: el,
                    ...
                    $.ajax({
                        url: '{{ route("frontend.get_attribute_by_type") }}',
                        type: "POST",
                        data: {
                            _token: '{{ csrf_token() }}',
                            id: el,
                ...
                $.ajax({
                    url: '{{ route("frontend.product_filter_by_type") }}',
                    type: "POST",
                    data: {
                        _token: '{{ csrf_token() }}',

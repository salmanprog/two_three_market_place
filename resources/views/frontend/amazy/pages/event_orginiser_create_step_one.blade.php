                    ...
                    <div class="row">
                        ...
                        @else
                            ...
                            <div class="col-lg-12 mb_20">
                                <label class="primary_label2">{{ __('Event Organiser Name') }} <span>*</span></label>
                                <input type="text" name="name" id="Shop" value="{{old('name')}}" placeholder="{{ __('Event Organiser Name') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{ __('Event Organiser Name') }}'" class="primary_input3 radius_5px">
                                @error('name')
                                    <span class="text-danger" >{{ $message }}</span>
                                @enderror
                            </div>

    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-6 col-md-10 mb_50">
                <div class="section__title">
                    <h3 class="mb_40">Art Gallery Subscription</h3>
                    Art gallery registration involves the planning, coordination, and presentation of artwork in a physical or virtual gallery space. Art galleries handle everything from artwork curation and installation to sales facilitation, promotions, and on-site management.
                </div>
            </div>
        </div>
        <div class="row justify-content-center" >
            ...
            <form class="price_subscription_add d-none"
                action="{{ route('frontend.art-gallery-subscription-type') }}" method="get">

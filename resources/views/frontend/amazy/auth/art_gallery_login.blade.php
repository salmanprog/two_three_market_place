...
<div class="amazy_login_area">
    <div class="amazy_login_area_left d-flex align-items-center justify-content-center">
        <div class="amazy_login_form">
            ...
            <form action="{{ route('art-gallery.login_submit') }}" method="POST" name="login" id="login_form">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="sign_up_text">{{__('amazy.Don’t have an Account?')}} <a href="{{ route('frontend.art-gallery-register', 'subscription') }}">{{__('amazy.Sign Up')}}</a></p>
                    </div>
                </div>
            </form>
        </div>
